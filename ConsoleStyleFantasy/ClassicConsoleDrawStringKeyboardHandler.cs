...
namespace SadConsole.Components
{
    ...
    /// </summary>
    public class ClassicConsoleDrawStringKeyboardHandler : KeyboardConsoleComponent
    {
        ...
        /// </summary>
        public Action<ClassicConsoleDrawStringKeyboardHandler, Cursor, string> EnterPressedAction = (h, c, s) => { };

        /// <summary>
        /// Creates the handler with the specified prompt.
        /// </summary>
        /// <param name="prompt">The prompt to display to the user.</param>
        public ClassicConsoleDrawStringKeyboardHandler(string prompt = "> ") =>
            Prompt = prompt;
